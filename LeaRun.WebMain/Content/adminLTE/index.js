        ...
        addTab: function () {
            ...
            var flag = true;
                ...
                $.ajax({
                    ...
                    data: { moduleId: dataId, moduleName: menuName, moduleUrl: dataUrl },
                    type: "post",
                    dataType: "text",
                });
            if (dataUrl == undefined || $.trim(dataUrl).length == 0) {
    ...
    $.learunindex = {
        load: function () {
            ...
            $(window).resize(function (e) {
                $("#content-wrapper").find('.mainContent').height($(window).height() - 90);
                //2016年11月16日 处理菜单自适应--fwqkey
                var _height1 = $(window).height() - $("#sidebar-menu >li.active").position().top - 41;
           //     var _height3 = $("#sidebar-menu li > ul.menu-open>li").length * $("#sidebar-menu li > ul.menu-open>li").height() + 10;
                var _height3 = $("li.active > ul.menu-open>li").length * 35 + 10;
                var _height = _height1 > _height3 ? _height3 : _height1;
