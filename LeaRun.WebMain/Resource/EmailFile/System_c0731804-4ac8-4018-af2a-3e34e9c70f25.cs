...
namespace Himall.Web.Areas.Web.Controllers
{
    public class InstallerController : Controller
    {
        ...
        private string GetConnectionString()
        {
            ...
            return String.Format(
                "server={0};database={1};user id={2};password={3};persistsecurityinfo=True;charset=utf8;",
        ...
        private string GetEFConnectionString()
        {
            ...
            return String.Format(
                "metadata=res://*/Entities.csdl|res://*/Entities.ssdl|res://*/Entities.msl;provider=MySql.Data.MySqlClient;provider connection string=\" server={0}{1};user id={2};password={3};persistsecurityinfo=True;database={4};charset=utf8\";",
        ...
        private bool CreateDtabase(out string msg)
        {
            ...
            using (DbConnection con = new MySqlConnection(connection))
            {
                ...
                com.CommandText = "CREATE DATABASE " + _dbName + "  DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci";
        ...
        private bool CreateAdministrator(out string errorMsg)
        {
            ...
            try
            {
                using (connection = new MySqlConnection(GetConnectionString()))
                {
                    ...
                    long shopId = (long)dbCmd.ExecuteScalar();
                    ...
                    dbCmd.Parameters.Clear();
                    dbCmd.CommandText =
                       "INSERT INTO Himall_Members  (UserName, Password, PasswordSalt,TopRegionId,RegionId,OrderNumber,Disabled,Points,Expenditure,CreateDate,LastLoginDate)" +
                       "VALUES (@userName, @Password, @PasswordSalt,0,0,0,0,0,0.00,@CreateDate,@LastLoginDate )";
                    dbCmd.Parameters.Add(new MySqlParameter("@userName", _shopAdminName));
                    dbCmd.Parameters.Add(new MySqlParameter("@Password", shopPwd));
                    dbCmd.Parameters.Add(new MySqlParameter("@PasswordSalt", shopPwdSalt));
                    dbCmd.Parameters.Add(new MySqlParameter("@CreateDate", DateTime.Now));
