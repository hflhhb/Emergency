...
namespace LeaRun.CodeGenerator.Template
{
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("namespace LeaRun." + baseConfigModel.OutputAreas + ".Entity\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
        ...
        public string EntityMapBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace LeaRun." + baseConfigModel.OutputAreas + ".Mapping\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2017-2020 肖海根\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace LeaRun." + baseConfigModel.OutputAreas + ".Service\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.5\r\n");
            sb.Append("    /// Copyright (c) 2017-2020 肖海根\r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace LeaRun." + baseConfigModel.OutputAreas + ".Business\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.5\r\n");
            sb.Append("    /// Copyright (c) 2017-2020 肖海根\r\n");
