    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("namespace LeaRun." + multiTableConfigModel.OutputAreas + ".Entity\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using LeaRun." + multiTableConfigModel.OutputAreas + ".Entity;\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace LeaRun." + multiTableConfigModel.OutputAreas + ".Mapping\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2017-2020 肖海根\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> colModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using LeaRun." + multiTableConfigModel.OutputAreas + ".Entity;\r\n");
            sb.Append("using LeaRun." + multiTableConfigModel.OutputAreas + ".IService;\r\n");
            ...
            sb.Append("namespace LeaRun." + multiTableConfigModel.OutputAreas + ".Service\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.5\r\n");
            sb.Append("    /// Copyright (c) 2017-2020 肖海根\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace LeaRun." + multiTableConfigModel.OutputAreas + ".IService\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.5\r\n");
            sb.Append("    /// Copyright (c) 2017-2020 肖海根\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using LeaRun." + multiTableConfigModel.OutputAreas + ".Entity;\r\n");
            sb.Append("using LeaRun." + multiTableConfigModel.OutputAreas + ".IService;\r\n");
            sb.Append("using LeaRun." + multiTableConfigModel.OutputAreas + ".Service;\r\n");
            sb.Append("using LeaRun.Util.Web;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace LeaRun." + multiTableConfigModel.OutputAreas + ".Business\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 1.5\r\n");
            sb.Append("    /// Copyright (c) 2017-2020 肖海根\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using LeaRun." + multiTableConfigModel.OutputAreas + ".Entity;\r\n");
            sb.Append("using LeaRun." + multiTableConfigModel.OutputAreas + ".Business;\r\n");
            sb.Append("using LeaRun.Util;\r\n");
            sb.Append("using LeaRun.Util.Web;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
