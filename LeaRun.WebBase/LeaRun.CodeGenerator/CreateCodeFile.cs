...
namespace LeaRun.CodeGenerator
{
    ...
    public class CreateCodeFile
    {
        ...
        public static void CreateExecution(BaseConfigModel baseConfigModel, string strCode)
        {
            ...
            string entityPath = baseConfigModel.OutputEntity  + "\\" + baseConfigModel.EntityClassName + ".cs";
            ...
            string entitymapPath = baseConfigModel.OutputMap  + "\\" + baseConfigModel.MapClassName + ".cs";
            ...
            string servicePath = baseConfigModel.OutputService  + "\\" + baseConfigModel.ServiceClassName + ".cs";
            ...
            string iservicePath = baseConfigModel.OutputIService  + "\\" + baseConfigModel.IServiceClassName + ".cs";
            ...
            string businesPath = baseConfigModel.OutputBusines  + "\\" + baseConfigModel.BusinesClassName + ".cs";
        ...
        public static void CreateExecution(MultiTableConfigModel baseConfigModel, string strCode)
        {
            ...
            string entityChildPath = baseConfigModel.OutputEntity  + "\\" + baseConfigModel.ChildTableName + "Entity.cs";
            ...
            string entitymapChildPath = baseConfigModel.OutputMap  + "\\" + baseConfigModel.ChildTableName + "Map.cs";
