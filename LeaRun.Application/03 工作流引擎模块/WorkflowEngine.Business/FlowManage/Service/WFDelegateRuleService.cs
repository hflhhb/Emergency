...
namespace LeaRun.WorkflowEngine.Service
{
    ...
    /// </summary>
    public class WFDelegateRuleService : DaoFactory, WFDelegateRuleIService
    {
        /// <summary>
        /// 带连接字符串参数的构造函数
        /// </summary>
        /// <param name="dbcontext"></param>
        public WFDelegateRuleService(DbContextBase dbcontext) : base(dbcontext){ }
        ...
        public DataTable GetEntityBySchemeInfoId(string shcemeInfoId,string[] objectIdList)
        {
            try
            {
                IPermissionService service = new PermissionService(LeaRun.Data.DbFactory.Base());
                string userIdlist = "";
        ...
        public WFDelegateRuleEntity GetEntity(string keyValue)
        {
            try
            {
               return base.db.FindEntity<WFDelegateRuleEntity>(keyValue);
            }
            catch
            {
                throw;
