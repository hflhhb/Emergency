...
namespace LeaRun.WorkflowEngine.Service
{
    ...
    /// </summary>
    public class WFSchemeInfoService : DaoFactory, WFSchemeInfoIService
    {
        private IUserService userservice = new UserService(LeaRun.Data.DbFactory.Base());

        /// <summary>
        /// 带连接字符串参数的构造函数
        /// </summary>
        /// <param name="dbcontext"></param>
        public WFSchemeInfoService(DbContextBase dbcontext) : base(dbcontext){ }
        ...
        public DataTable GetList()
        {
            try
            {
                ...
                return base.db.FindTable(strSql.ToString());
            }
            catch
            {
                throw;
        ...
        public WFSchemeInfoEntity GetEntity(string keyValue)
        {
            try
            {
                return base.db.FindEntity<WFSchemeInfoEntity>(keyValue);
            }
            catch (Exception)
            {
                throw;
        ...
        public IEnumerable<WFSchemeInfoAuthorizeEntity> GetAuthorizeEntityList(string schemeInfoId)
        {
            try
            {
                ...
                return base.db.FindList<WFSchemeInfoAuthorizeEntity>(expression);
            }
            catch
            {
                throw;
