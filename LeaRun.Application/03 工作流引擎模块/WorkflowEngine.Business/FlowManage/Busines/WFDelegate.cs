...
namespace LeaRun.WorkflowEngine.Business
{
    ...
    {
        private WFDelegateRuleIService wfDelegateRuleService = new WFDelegateRuleService(LeaRun.Data.DbFactory.Platform());
        private WFDelegateRecordIService wfDelegateRecordService = new WFDelegateRecordService(LeaRun.Data.DbFactory.Platform());
        #region 获取数据
        /// <summary>
        /// 获取委托规则分页数据
        /// </summary>
