...
using LeaRun.WorkflowEngine.Service;
using LeaRun.Util;
using LeaRun.Util.Web;
using System;
using System.Data;

namespace LeaRun.WorkflowEngine.Business
{
    /// <summary>
    /// 版 本 1.5
    ...
    {
        private WFProcessInstanceIService wfProcessInstanceService = new WFProcessInstanceService(LeaRun.Data.DbFactory.Platform());
        private WFProcessSchemeIService wfProcessSchemeService = new WFProcessSchemeService(LeaRun.Data.DbFactory.Platform());
        private WFRuntimeIService wfRuntimeService = new WFRuntimeService(LeaRun.Data.DbFactory.Platform());
        #region 获取数据
        /// <summary>
        /// 获取流程实例分页数据
        /// </summary>
