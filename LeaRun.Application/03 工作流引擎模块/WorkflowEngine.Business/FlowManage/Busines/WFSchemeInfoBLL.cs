...
namespace LeaRun.WorkflowEngine.Business
{
    ...
    {
        private WFSchemeInfoIService infoserver = new WFSchemeInfoService(LeaRun.Data.DbFactory.Platform());
        private WFSchemeContentIService schemeserver = new WFSchemeContentService(LeaRun.Data.DbFactory.Platform());
        ...
        {
            DbContextBase db = new DaoFactory(LeaRun.Data.DbFactory.Platform()).db;
            db.BeginTrans();
            try
            {
