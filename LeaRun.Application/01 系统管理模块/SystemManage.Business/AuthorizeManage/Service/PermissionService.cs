...
namespace LeaRun.UserManage.Service
{
    ...
    /// </summary>
    public class PermissionService : Dao<AuthorizeEntity>, IPermissionService
    {
        /// <summary>
        /// 带连接字符串参数的构造函数
        /// </summary>
        /// <param name="dbcontext"></param>
        public PermissionService(DbContextBase dbcontext) : base(dbcontext){ }
        ...
        {
            return base.db.Queryable<UserRelationEntity>(t => t.ObjectId == objectId).OrderByDescending(t => t.CreateDate).ToList();
        }
        /// <summary>
        /// 获取对象列表
        /// </summary>
        ...
        {
            return base.db.Queryable<UserRelationEntity>(t => t.UserId == userId).OrderByDescending(t => t.CreateDate).ToList();
        }
        /// <summary>
        /// 获取功能列表
        /// </summary>
        ...
        {
            return base.db.Queryable<AuthorizeEntity>(t => t.ObjectId == objectId && t.ItemType == 1).ToList();
        }
        /// <summary>
        /// 获取按钮列表
        /// </summary>
        ...
        {
            return base.db.Queryable<AuthorizeEntity>(t => t.ObjectId == objectId && t.ItemType == 2).ToList();
        }
        /// <summary>
        /// 获取视图列表
        /// </summary>
        ...
        {
            return base.db.Queryable<AuthorizeEntity>(t => t.ObjectId == objectId && t.ItemType == 3).ToList();
        }
        /// <summary>
        /// 获取数据权限列表
        /// </summary>
        ...
        {
            return base.db.Queryable<AuthorizeDataEntity>(t => t.ObjectId == objectId).OrderBy(t => t.SortCode).ToList();
        }
        #endregion
