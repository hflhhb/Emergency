...
namespace LeaRun.UserManage.Service
{
    ...
    /// 描 述：用户管理
    /// </summary>
    public class UserService : Dao<UserEntity>, IUserService
    {
        private IAuthorizeService<UserEntity> iauthorizeservice = null;
        ...
        {
            iauthorizeservice = new AuthorizeService<UserEntity>(dbcontext);
        }
