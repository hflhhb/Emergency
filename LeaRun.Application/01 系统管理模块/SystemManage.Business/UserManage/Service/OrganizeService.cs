...
namespace LeaRun.UserManage.Service
{
    ...
    /// 描 述：机构管理
    /// </summary>
    public class OrganizeService : Dao<OrganizeEntity>, IOrganizeService
    {
        /// <summary>
        /// 带连接字符串参数的构造函数
        /// </summary>
        /// <param name="dbcontext"></param>
        public OrganizeService(DbContextBase dbcontext) : base(dbcontext){ } 
        ...
        {
            return base.Queryable().OrderByDescending(t => t.SortCode).ToList();
        }
        /// <summary>
        /// 机构实体
        /// </summary>
        ...
        public void SaveForm(string keyValue, OrganizeEntity organizeEntity)
        {
            if (!string.IsNullOrEmpty(keyValue))
            {
                ...
                base.Update(organizeEntity);
            }
            else
            {
                organizeEntity.Create();
                base.Insert(organizeEntity);
            }
        }
        #endregion
    }
