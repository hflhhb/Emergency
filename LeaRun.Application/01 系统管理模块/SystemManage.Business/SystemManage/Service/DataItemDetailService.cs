...
using LeaRun.SystemManage.Entity.ViewModel;
...
namespace LeaRun.SystemManage.Service
{
    ...
    /// 描 述：数据字典明细
    /// </summary>
    public class DataItemDetailService : Dao<DataItemDetailEntity>, IDataItemDetailService
    {
        /// <summary>
        /// 带连接字符串参数的构造函数
        /// </summary>
        /// <param name="dbcontext"></param>
        public DataItemDetailService(DbContextBase dbcontext) : base(dbcontext){ }
        ...
        {
            return base.Queryable(t => t.ItemId == itemId).OrderBy(t => t.SortCode).ToList();
        }
        /// <summary>
        /// 明细实体
        /// </summary>
        ...
        public IEnumerable<DataItemModel> GetDataItemList()
        {
            ...
            return base.db.FindList<DataItemModel>(strSql.ToString());
        }
        #endregion
        ...
        public void SaveForm(string keyValue, DataItemDetailEntity dataItemDetailEntity)
        {
            if (!string.IsNullOrEmpty(keyValue))
            {
                ...
                base.Update(dataItemDetailEntity);
            }
            else
            {
                dataItemDetailEntity.Create();
                base.Insert(dataItemDetailEntity);
            }
        }
        #endregion
    }
