...
namespace LeaRun.SystemManage.Business
{
    ...
    {
        private ICodeRuleService service = new CodeRuleService(DbFactory.Base());
        ...
        {
            return service.UseRuleSeed(userId, moduleId, enCode );
        }
        /// <summary>
        /// 获得指定模块或者编号的单据号（直接使用）
        /// </summary>
        ...
        {
            return service.SetBillCode(userId, moduleId, enCode);
        }
        #endregion
    }
}
