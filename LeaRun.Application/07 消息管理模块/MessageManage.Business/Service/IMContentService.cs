...
namespace LeaRun.MessageManage.Service
{
    ...
    /// 描 述：即时通信群组管理
    /// </summary>
    public class IMContentService : Dao<IMContentEntity>, IMsgContentService
    {
        /// <summary>
        /// 带连接字符串参数的构造函数
        /// </summary>
        /// <param name="dbcontext"></param>
        public IMContentService(DbContextBase dbcontext) : base(dbcontext){ }
        ...
        public IEnumerable<IMReadModel> GetList(Pagination pagination, string userId, string sendId,string flag = "1")
        {
            ...
            return base.db.FindList<IMReadModel>(strSql.ToString(), parameter.ToArray(), pagination);
        }
        /// <summary>
        /// 获取消息列表（群组）
        /// </summary>
        ...
        public IEnumerable<IMReadNumModel> GetReadList(string userId)
        {
            ...
            return base.db.FindList<IMReadNumModel>(strSql.ToString(), parameter.ToArray());
        }
        /// <summary>
        /// 获取某用户某种消息的总数
        /// </summary>
        ...
        public int Update(string userId, string sendId, string status)
        {
            ...
            return base.ExecuteNonQuery(strSql.ToString(), parameter.ToArray());
        }
        #endregion
    }
}
