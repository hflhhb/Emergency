...
namespace LeaRun.ResourceManage.Service
{
    ...
    /// 描 述：School
    /// </summary>
    public class SchoolService : Dao<SchoolEntity>, ISchoolService
    {
        /// <summary>
        /// 带连接字符串参数的构造函数
        /// </summary>
        /// <param name="dbcontext"></param>
        public SchoolService(DbContextBase dbcontext) : base(dbcontext)
        {
        }
        #region 获取数据
        /// <summary>
        ...
        public IEnumerable<SchoolEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<SchoolEntity> GetList(string queryJson)
        {
        ...
        {
            var expression = LinqExtensions.True<SchoolEntity>();
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, SchoolEntity entity)
        {
