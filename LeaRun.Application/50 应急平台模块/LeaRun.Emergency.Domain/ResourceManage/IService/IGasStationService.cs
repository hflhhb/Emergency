...
namespace LeaRun.ResourceManage.IService
{
    ...
    public interface IGasStationService
    {
        ...
        IEnumerable<GasStationEntity> GetPageList(Pagination pagination, string queryJson);
        /// <summary>
        /// 获取列表
        /// </summary>
        /// <param name="queryJson">查询参数</param>
        ...
        /// <returns></returns>
        GasStationEntity GetEntity(string keyValue);
        #endregion
        ...
        /// <returns></returns>
        void SaveForm(string keyValue, GasStationEntity entity);
        #endregion
    }
}
