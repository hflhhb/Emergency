...
namespace LeaRun.Util
{
    ...
    public class ConvertJson
    {
        ...
        //    {
        //        object objectValue = propertyInfo.GetGetMethod().Invoke(jsonObject, null);
        ...
        //            value = objectValue.ToString();
        //        }
        //        jsonString += "\"" + propertyInfo.Name + "\":" + value + ",";
        //    }
        //    jsonString = jsonString.Remove(jsonString.LastIndexOf(","));
        //    return jsonString + "}";
        //}
        ...
        public static string ToJson(DataTable dt)
        {
            ...
            for (int i = 0; i < drc.Count; i++)
            {
                ...
                for (int j = 0; j < dt.Columns.Count; j++)
                {
                    ...
                    string strValue = drc[j].ToString();
        ...
        public static string ToJson(DbDataReader dataReader)
        {
            ...
            while (dataReader.Read())
            {
                ...
                for (int i = 0; i < dataReader.FieldCount; i++)
                {
                    ...
                    string strValue = dataReader.ToString();
                    jsonString.Append("\"" + strKey + "\":");
                    strValue = StringFormat(strValue, type);
